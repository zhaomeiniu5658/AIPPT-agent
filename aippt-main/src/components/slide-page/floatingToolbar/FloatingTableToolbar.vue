<template>
  ...
  >
    ...
    <a-button 
      @click="$emit('add-row')"
      :title="t('slide.visual.table.addRow')"
    >
      <Icon name="table-row-add" :size="16"/>
    </a-button>

    <!-- Delete Row Button -->
    <a-button 
      @click="$emit('delete-row')"
      :title="t('slide.visual.table.deleteRow')"
    >
      <Icon name="table-row-delete" :size="16" />
    </a-button>
    ...
    <a-button 
      ...
      :title="t('slide.visual.table.addColumn')"
    >
      <template #icon>
        <Icon name="table-column-add"  :size="16"/>
    ...
    <a-button 
      ...
      :title="t('slide.visual.table.deleteColumn')"
    >
      <template #icon>
        <Icon name="table-column-delete" :size="16" />
      </template>
