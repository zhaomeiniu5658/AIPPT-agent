<template>
  <div class="media-panel">
    ...
    <div class="panel-header">
      <h3 class="panel-title">{{ t('slide.visual.categories.media') }}</h3>
    ...
    <div class="panel-body">
      <div class="component-grid component-grid-3col">
        <ComponentCard v-for="component in mediaComponents" :key="component.id" :component="component"
          @click="handleComponentClick" @coming-soon="handleComingSoon" />
      </div>
    </div>
  </div>
</template>
...
const { t } = useI18n()
const { getMediaComponents } = useComponentRegistry()
...
// Computed
const mediaComponents = computed(() => getMediaComponents())
const description = computed(() => {
  return t('slide.visual.media.description') || 'Add videos and audio to your slides.'
})
